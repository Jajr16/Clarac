...
if (!Permisos['ALMACÉN']) {
    ...
    if ((pathname == "/users/petalm" || pathname == "/users/Petalm") && (Permisos['ALMACÉN'].includes('4') && Permisos['ALMACÉN'].includes('2') && Permisos['ALMACÉN'].includes('1') && Permisos['ALMACÉN'].includes('3'))) {
        function initStatus() {
